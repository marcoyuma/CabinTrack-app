 ...
 *
 * Moved from features/cabins/services (deleted — see dashboard-migration plan) since
 * features/authentication also needs it for avatar uploads and it isn't cabin-specific.
 *
