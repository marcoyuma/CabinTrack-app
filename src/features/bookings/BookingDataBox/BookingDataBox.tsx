...
import { Cabin as CabinType } from "../../../types/cabins.type";
...
function BookingDataBox({ booking }: { booking: DetailedBookingDataType }) {
    const {
        created_at,
        startDate,
        endDate,
    ...
    const { name: cabinName } = cabins ?? ({} as CabinType);
    const {
        fullName: guestName,
        email,
        nationality,
